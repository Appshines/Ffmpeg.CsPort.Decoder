...
{
	/// <summary>
	/// Stores the fixed MPEG-4 ALS predictor and long-term-prediction tables used by the managed decoder.
	/// </summary>
	internal static class Mp4AlsTables
	{
		internal static readonly sbyte[] ParcorRice =
		{
		...
		internal static readonly int[] ParcorScaledValues =
		{
		...
		internal static readonly byte[] LongTermPredictionGains =
		{
