...
{
	/// <summary>
	/// Carries the fields decoded from one FLAC frame header before subframe processing begins.
	/// </summary>
	internal readonly struct FlacFrameHeader
	{
		...
		public long FrameOrSampleNumber { get; }
		public bool IsVariableBlockSize { get; }
			...
			bool isVariableBlockSize)
		{
			...
			IsVariableBlockSize = isVariableBlockSize;
		}
	}
}
